...
#include "Item.h"
#include "GameState.h"
#include "EnhancedEnemyAI.h" // Update to use our new enhanced AI
#include <vector>
#include <string>
#include <iostream>
#include <cmath>
...
// Create an instance of the enhanced AI
EnhancedEnemyAI enhancedAI;
    ...
    if (debugMode) {
        ...
        for (int i = 0; i < players.size(); i++) {
            ...
            if (i == 1) {
                ...
                // Get current AI state from EnhancedEnemyAI class
